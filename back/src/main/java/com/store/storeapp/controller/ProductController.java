...
public class ProductController {
	...
	@CrossOrigin
	@GetMapping("/product/provider/{provider}")
	public ResponseEntity<List<?>> getAllProductByProvider(@PathVariable Provider provider){
		List<Product> product = productService.getAllProductByProvider(provider);
		return utilM.getAll(product);
	}
